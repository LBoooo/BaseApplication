...
open class AppDialog : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //如果是继承了AppDialog，那么就会重写extendsOptions()方法
     ...
     */
    fun showOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle): AppDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
     ...
     * @param tag
     */
    fun showOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle, tag: String?): AppDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
            this.animStyle = newAnim
     ...
     * @param tag
     */
    fun showNowOnWindow(manager: FragmentManager, gravity: DialogGravity = dialogOptions.gravity, @StyleRes newAnim: Int? = dialogOptions.animStyle, tag: String?): AppDialog {
        myIsShow = true
        dialogOptions.apply {
            this.gravity = gravity
            this.animStyle = newAnim
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView): AppDialog {
        myIsShow = true
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView, @StyleRes newAnim: Int? = dialogOptions.animStyle): AppDialog {
        myIsShow = true
     ...
     */
    fun showOnView(manager: FragmentManager, view: View, gravityAsView: DialogGravity = dialogOptions.gravityAsView, @StyleRes newAnim: Int? = dialogOptions.animStyle, offsetX: Int = dialogOptions.offsetX, offsetY: Int = dialogOptions.offsetY): AppDialog {
        myIsShow = true
