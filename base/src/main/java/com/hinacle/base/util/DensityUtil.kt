...
inline val Float.dp get() = this * AppUtil.application.resources.displayMetrics.density + 0.5F
inline val Int.dp get() = (this * AppUtil.application.resources.displayMetrics.density + 0.5F).toInt()
//
//// px 转 dp
inline val Float.px get() = this / AppUtil.application.resources.displayMetrics.density + 0.5F
inline val Int.px get() =  (this / AppUtil.application.resources.displayMetrics.density + 0.5F).toInt()
//
//// sp 转 px
inline val Float.sp get() = this * AppUtil.application.resources.displayMetrics.density + 0.5F
inline val Int.sp get() = (this * AppUtil.application.resources.displayMetrics.density + 0.5F).toInt()
//
//// px 转 sp
inline val Float.spx get() = this / AppUtil.application.resources.displayMetrics.density + 0.5F
inline val Int.spx get() = (this / AppUtil.application.resources.displayMetrics.density + 0.5F).toInt()
////////////////////////////////////////////////////////////////////////////////////////////////////
